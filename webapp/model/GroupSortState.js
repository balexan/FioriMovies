sap.ui.define([
	...
	return BaseObject.extend("movies.sap.com.model.GroupSortState", {
		 ...
		 * @alias movies.sap.com.model.GroupSortState
		 */
		...
		/**
		 * Groups by YEAR, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "YEAR") {
				...
				this._oViewModel.setProperty("/sortBy", "YEAR");

				aSorters.push(
					new Sorter("YEAR", false,
