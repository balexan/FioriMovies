			...
			onTheMasterPage : {
							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("Movies", {
											ID : sCurrentId
										});
				...
				assertions : {
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("YEAR");
					},

					theListShouldBeSortedAscendingOnName : function () {
						return this.theListShouldBeSortedAscendingOnField("TITLE");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all Movies to be able to check for the total amount
