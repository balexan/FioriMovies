sap.ui.define([
		...
		opaTest("MasterList Filtering on YEAR less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<YEAR>").
				and.iSelectListItemInViewSettingsDialog("<100 <>").
		...
		opaTest("MasterList Filtering on YEAR more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <>").
				and.iPressOKInViewSelectionDialog();
