...
sap.ui.define([
		...
		return BaseController.extend("movies.sap.com.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("movies.sap.com.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("YEAR", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("YEAR", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
